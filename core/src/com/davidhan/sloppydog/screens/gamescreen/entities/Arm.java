...
public class Arm extends CompoundPhysicalEntity implements Grabber {
    ...
    com.davidhan.sloppydog.screens.gamescreen.entities.Grabbable grabRequestedBody;
    com.davidhan.sloppydog.screens.gamescreen.entities.Grabbable grabbed;
    Joint grabbedJoint;
    int playerNum;
    ...
    protected void makeBodies(World world) {
     //   links = com.davidhan.sloppydog.screens.gamescreen.box2d.BodyFactory.createDogBody(world);
       // hand = com.davidhan.sloppydog.screens.gamescreen.box2d.BodyFactory.createHand(world, links.get(0));
    ...
    private void drawLink(Batch batch, float parentAlpha, List<Sprite> sprites) {
        for (int i = 0; i < links.size(); i++) {
            ...
            shaftSprite.setCenter(
                    linkBody.getPosition().x * com.davidhan.sloppydog.constants.Display.WORLDSCALE,
                    linkBody.getPosition().y * com.davidhan.sloppydog.constants.Display.WORLDSCALE
            );
    ...
    @Override
    public com.davidhan.sloppydog.screens.gamescreen.entities.Grabbable getGrabbing() {
        return grabbed;
    }
    ...
    public void releaseGrabbed() {
        if(grabbed != null) {
            temp1.set(0, com.davidhan.sloppydog.constants.GameConst.Arm.HAND_RADIUS+grabbed.getRadius()+0.5f);
    ...
    public void move(int dire) {
        Vector2 vec = new Vector2(0, com.davidhan.sloppydog.constants.GameConst.Arm.IMPULSE_POWER);
...
//        tunnelUp();
    ...
    public float getLinkBottomY(int linkNum) {
        ...
        return link.getWorldPoint(temp1.set(0, -com.davidhan.sloppydog.constants.GameConst.Arm.ARM_RADIUS - com.davidhan.sloppydog.constants.GameConst.Arm.LINK_HALF_LENGTH)).y;
    }

    public boolean isFullyInArena() {
        return tail.getWorldPoint(temp1.set(0, -com.davidhan.sloppydog.constants.GameConst.Arm.ARM_RADIUS - com.davidhan.sloppydog.constants.GameConst.Arm.LINK_HALF_LENGTH)).y - 0.1f > 0;
    }
    ...
    public void requestGrab(com.davidhan.sloppydog.screens.gamescreen.entities.Grabbable grabbable) {
        grabRequestedBody = grabbable;
    }
    private void grab(com.davidhan.sloppydog.screens.gamescreen.entities.Grabbable grabbable) {
        WeldJointDef jointDef = new WeldJointDef ();


        jointDef.initialize(hand, grabbable.body(), grabbable.body().getPosition());
        jointDef.localAnchorA.set(0, com.davidhan.sloppydog.constants.GameConst.Arm.HAND_RADIUS);
